  ...
  return (
    <>
      ...
      <SectionHero
        ...
        subtitle="Five core values guide every decision we make at Aegis — from the code we write to the customers we serve. These are not aspirational platitudes. They are operational principles that have been tested under fire and proven in the field."
