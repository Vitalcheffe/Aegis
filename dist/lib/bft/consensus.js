...
// ============================================================================
class BFTConsensus {
    constructor(n = 10, byzantineIndices = [2, 5, 8]) {
        this.leaderRotationInterval = 100;
        this.exclusionDuration = 100;
     ...
     */
    runUntilConvergence(trueValue, startTick, maxRounds = 50, rng) {
        let totalRounds = 0;
        let result;
        const allByzantineDetected = [];
