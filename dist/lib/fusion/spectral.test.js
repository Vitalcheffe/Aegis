...
describe('Power Iteration', () => {
    test('converges for identity matrix (eigenvalue=1)', () => {
        const I = [[1, 0], [0, 1]];
        const { eigenvalue, eigenvector } = (0, spectral_1.powerIteration)(I);
    ...
    test('finds principal eigenvector of 2×2 matrix', () => {
        ...
        const M = [[2, 1], [1, 2]];
        const { eigenvalue, eigenvector } = (0, spectral_1.powerIteration)(M);
    ...
    test('converges for 5×5 matrix', () => {
        ...
        const { eigenvalue } = (0, spectral_1.powerIteration)(M);
